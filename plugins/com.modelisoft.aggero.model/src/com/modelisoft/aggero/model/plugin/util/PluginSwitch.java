 ...
 * @generated
 */
public class PluginSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PluginPackage.PLUGIN: {
				...
				if (result == null) result = caseExecutableProject(plugin);
				if (result == null) result = caseProject(plugin);
				if (result == null) result = caseNamedElement(plugin);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PluginPackage.FRAGMENT: {
				Fragment fragment = (Fragment)theEObject;
				T result = caseFragment(fragment);
				if (result == null) result = caseExecutableProject(fragment);
				if (result == null) result = caseProject(fragment);
