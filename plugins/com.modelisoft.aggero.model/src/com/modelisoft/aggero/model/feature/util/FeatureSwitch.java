...
public class FeatureSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FeaturePackage.FEATURE_CONTENT: {
				FeatureContent featureContent = (FeatureContent)theEObject;
				T result = caseFeatureContent(featureContent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FeaturePackage.FEATURE_DEPENDENCIES: {
	 ...
	 * @generated
	 */
	public T caseFeatureContent(FeatureContent object) {
		return null;
	}
