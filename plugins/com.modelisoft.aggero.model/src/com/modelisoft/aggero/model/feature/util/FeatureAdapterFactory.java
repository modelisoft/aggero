/**
 */
package com.modelisoft.aggero.model.feature.util;
...
public class FeatureAdapterFactory extends AdapterFactoryImpl {
	...
	protected FeatureSwitch<Adapter> modelSwitch =
		new FeatureSwitch<Adapter>() {
			...
			@Override
			public Adapter caseFeatureContent(FeatureContent object) {
				return createFeatureContentAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.modelisoft.aggero.model.feature.Feature <em>Feature</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.modelisoft.aggero.model.feature.FeatureContent <em>Content</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFeatureContentAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link com.modelisoft.aggero.model.feature.FeatureDependencies <em>Dependencies</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
